  ...
  async redirects() {
    return [
      ...
      ...[
        ...
        source: `/Webshop%20pictures/accessoiries/phone%20charm/bint-saeed-${stone}-al-ain-rosette-phone-charm-front.webp`,
        destination: `/Webshop%20pictures/accessoiries/phone%20charm/bint-saeed-${stone}-al-quaa-phone-charm-front.webp`,
        permanent: true,
      })),
      ...
      { source: '/login/:path*', destination: '/admin/login', permanent: false },
      ...['ar', 'fr', 'it', 'es', 'ru', 'zh', 'de', 'nl', 'pt', 'id', 'ms'].flatMap((locale) => [
        { source: `/${locale}/dashboard`, destination: '/admin/dashboard', permanent: false },
        { source: `/${locale}/dashboard/:path*`, destination: '/admin/dashboard', permanent: false },
        { source: `/${locale}/login`, destination: '/admin/login', permanent: false },
        { source: `/${locale}/login/:path*`, destination: '/admin/login', permanent: false },
      ]),
