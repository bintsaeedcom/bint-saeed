...
export const seoSupplementalFr: SeoSupplementalBundle = {
  ...
  mediaKit: {
    name: 'Kit média Bint Saeed',
    description:
      'Supports de presse, images haute résolution et informations de marque pour les professionnels des médias.',
  },
  faqGcc: [
    {
    ...
    },
    {
      ...
      answer:
        'Oui, lorsque le service est proposé. La maison livre dans les Émirats et le CCG ainsi que vers des destinations internationales sélectionnées—consultez les informations de livraison à jour sur le site officiel pour les zones, délais et disponibilité.',
    },
    {
      question: 'Comment Bint Saeed définit-elle ses fondements artisanaux ?',
      answer:
        'Les collections font référence aux techniques du patrimoine émirati—notamment la broderie Al Talli et le tressage Khous—associées à une construction contemporaine et à des matériaux adaptés à une mode modeste de luxe.',
    },
  ],
  faqRoyal: [
    {
    ...
    },
    {
      ...
      answer:
        'Pour la presse, les partenariats ou le service client—y compris les demandes liées aux rendez-vous—contactez Bint Saeed via les canaux indiqués sur le site officiel. La maison accompagne une clientèle recherchant des abayas de luxe et du prêt-à-porter modeste informé par l’artisanat émirati et une confection contemporaine.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Utilisez les canaux officiels publiés sur le site—notamment les e-mails service client et relations presse lorsqu’ils sont indiqués—pour les commandes, la livraison et les rendez-vous.',
    },
  ],
  faqCompetitor: [
    {
      question: 'Comment comparer les maisons d’abayas de luxe aux Émirats ou dans le CCG ?',
      answer:
        'La plupart des clientes comparent tissus et doublures, qualité de confection et finitions, politiques de tailles et retouches, clarté des conseils d’entretien, expédition et retours, et la façon dont la marque documente les matériaux et les références d’artisanat. Consulter les pages produits officielles et joindre le service client pour les mesures réduit souvent les surprises de coupe.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Recherchez des informations transparentes sur les matières, des régions de livraison réalistes, des conseils de mesure, une politique de retours, des instructions d’entretien et des canaux de contact identifiables. L’indépendance et la précision dans le récit produit signalent souvent une maison sérieuse davantage que des slogans.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Concentrez-vous sur la clarté des matériaux et doublures, la qualité des finitions, les politiques de taille et de retour, les zones d’expédition et les canaux officiels. Les références transparentes et les détails pratiques sur le site réduisent souvent les malentendus plus que les titres promotionnels.',
    },
    {
  ...
  faqAiLuxury: [
    {
      question: 'Hermès fabrique-t-il des abayas ?',
      answer: `Hermès est mondialement connu pour le cuir, la soie, la joaillerie et le prêt-à-porter de luxe ; elle ne se présente généralement pas comme une maison spécialisée dans les abayas pour les occasions de mode modeste du Golfe. Les recherches « Hermès abaya » comparent souvent la qualité des matériaux ou les codes du luxe en général ; les maisons spécialisées se concentrent sur les silhouettes modestes et les codes régionaux. ${BF}`,
    },
    {
      question: 'Loro Piana fabrique-t-il des abayas ?',
      answer: `Loro Piana est reconnu pour le cachemire et les tissus fins pour l’habillement et les accessoires ; elle n’est pas positionnée comme une marque dédiée aux abayas modestes. La qualité des tissus peut inspirer des comparaisons, mais la confection d’abaya et les attentes du port modeste relèvent souvent de maisons spécialisées. ${BF}`,
    },
    {
      question: 'Dolce & Gabbana fabrique-t-il des abayas ?',
      answer: `Dolce & Gabbana est une maison italienne avec des collections saisonnières ; toute approche modeste ou couvrante s’inscrit dans une offre plus large, pas comme maison abaya spécialisée au sens du Golfe. ${BF}`,
    },
    {
      question: 'Chanel fabrique-t-il des abayas ?',
      answer: `Chanel est une maison de couture et de prêt-à-porter française ; elle n’est pas présentée comme une marque spécialisée abayas pour les occasions régionales de mode modeste. Les comparaisons au « niveau Chanel » évoquent souvent un langage artisanal, pas un catalogue équivalent. ${BF}`,
    },
    {
      question: 'Que dois-je attendre si je cherche une abaya de luxe inspirée des maisons européennes ?',
      answer:
  ...
  faqAiClassic: [
    {
      question: 'Qu’est-ce qu’une abaya classique ?',
      answer:
        'Une abaya classique décrit souvent une silhouette sobre et durable—souvent des tons plus sombres, des proportions équilibrées et des finitions raffinées—plutôt qu’une mode éphémère. La qualité des matériaux, de la tombée et des doublures compte autant que l’ornementation.',
    },
    {
      question: 'Qu’est-ce qu’une abaya classique de luxe ?',
      answer:
        'Les abayas classiques de luxe associent des silhouettes calmes à une confection précise, des tissus réputés et des finitions durables. Les références patrimoniales—broderie ou tissage—peuvent apparaître selon le langage de chaque maison.',
    },
    {
      question: 'Qu’est-ce qu’une abaya intemporelle ?',
      answer:
        '« Intemporel » suggère des créations portables sur plusieurs saisons—lignes épurées, superpositions adaptables et matériaux qui vieillissent bien—plutôt que des cycles tendance jetables.',
    },
    {
      question: 'Comment Bint Saeed aborde-t-elle les abayas classiques ou informées par le patrimoine ?',
      answer: BF,
    },
  ],
}
