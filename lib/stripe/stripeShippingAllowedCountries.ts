...
/**
 * Stripe Checkout shipping_address_collection allowlist.
 * Includes every Stripe-supported destination (excludes AS, CX, CC, CU, HM, IR,
 * KP, MH, FM, NF, MP, PW, SD, SY, UM, VI — Stripe API rejects those).
 * Matches worldwide shipping marketing; non-Stripe rails (bank transfer / Tamara / Tabby)
 * can still serve destinations this list covers or that customers arrange offline.
 */
