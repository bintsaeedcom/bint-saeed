...
function frontAlts(color: ColorSlug): Record<AppLocale, string> {
  ...
  return altLoc(
    `Bint Saeed Park Lane Abaya in ${c.en}, front view. Contemporary A-line designer abaya with integrated shoulder scarf, signature gold-tone Knotted Line shoulder buttons, and wide cuffs with removable Bint Saeed signature gold-tone Monogram cufflinks. ${DISCOVERY_TAIL.en}`,
    ...
    `Bint Saeed Park Lane Abaya in ${c.it}, vista frontale. Abaya designer contemporanea A-line con sciarpa spalla integrata, bottoni dorati signature Knotted Line alle spalle e polsini ampi con gemelli Monogram Bint Saeed rimovibili. ${DISCOVERY_TAIL.it}`,
    `Abaya Bint Saeed Park Lane en ${c.es}, vista frontal. Abaya de diseñador contemporánea A-line con bufanda de hombro integrada, botones dorados signature Knotted Line en los hombros y puños anchos con gemelos Monogram Bint Saeed extraíbles. ${DISCOVERY_TAIL.es}`,
    ...
    `Abaya Bint Saeed Park Lane em ${c.pt}, vista frontal. Abaya de designer contemporânea A-line com lenço de ombro integrado, botões dourados signature Knotted Line nos ombros e punhos largos com abotoaduras Monogram Bint Saeed removíveis. ${DISCOVERY_TAIL.pt}`,
...
const BLACK_EXTRA_ALTS = altLoc(
  `Detail view of the Bint Saeed Park Lane Abaya in Deep Black — close-up of signature gold-tone Knotted Line shoulder buttons, removable Bint Saeed signature gold-tone Monogram cufflinks on wide cuffs, and integrated shoulder scarf against softly textured crepe. ${DISCOVERY_TAIL.en}`,
  ...
  `Vista dettagliata della Bint Saeed Park Lane Abaya in Nero profondo — primo piano dei bottoni dorati signature Knotted Line alle spalle, gemelli Monogram Bint Saeed rimovibili su polsini ampi e sciarpa spalla integrata su crepe morbido. ${DISCOVERY_TAIL.it}`,
  `Vista detallada de la abaya Bint Saeed Park Lane en Negro profundo — primer plano de botones dorados signature Knotted Line en hombros, gemelos Monogram Bint Saeed extraíbles en puños anchos y bufanda de hombro integrada sobre crepe texturizado. ${DISCOVERY_TAIL.es}`,
  ...
  `Vista detalhada da abaya Bint Saeed Park Lane em Preto profundo — close-up dos botões dourados signature Knotted Line nos ombros, abotoaduras Monogram Bint Saeed removíveis em punhos largos e lenço de ombro integrado sobre crepe macio. ${DISCOVERY_TAIL.pt}`,
...
const BLACK_LIFESTYLE_EXTRA_ALTS = altLoc(
  `Detail of the Bint Saeed Park Lane Abaya in Deep Black — close-up of wide cuffs with removable gold-tone Bint Saeed signature gold-tone Monogram cufflinks against softly textured crepe. ${DISCOVERY_TAIL.en}`,
  ...
  `Dettaglio della Bint Saeed Park Lane Abaya in Nero profondo — primo piano dei polsini ampi con gemelli Monogram Bint Saeed dorati rimovibili su crepe morbido. ${DISCOVERY_TAIL.it}`,
  `Detalle de la abaya Bint Saeed Park Lane en Negro profundo — primer plano de puños anchos con gemelos Monogram Bint Saeed dorados extraíbles sobre crepe texturizado. ${DISCOVERY_TAIL.es}`,
  ...
  `Detalhe da abaya Bint Saeed Park Lane em Preto profundo — close-up de punhos largos com abotoaduras Monogram Bint Saeed douradas removíveis sobre crepe macio. ${DISCOVERY_TAIL.pt}`,
...
const DARK_MAROON_LIFESTYLE_EXTRA_ALTS = altLoc(
  `Detail of the Bint Saeed Park Lane Abaya in Dark Maroon — close-up of wide cuffs with removable gold-tone Bint Saeed signature gold-tone Monogram cufflinks against softly textured crepe. ${DISCOVERY_TAIL.en}`,
  ...
  `Dettaglio della Bint Saeed Park Lane Abaya in Bordeaux scuro — primo piano dei polsini ampi con gemelli Monogram Bint Saeed dorati rimovibili su crepe morbido. ${DISCOVERY_TAIL.it}`,
  `Detalle de la abaya Bint Saeed Park Lane en Burdeos oscuro — primer plano de puños anchos con gemelos Monogram Bint Saeed dorados extraíbles sobre crepe texturizado. ${DISCOVERY_TAIL.es}`,
  ...
  `Detalhe da abaya Bint Saeed Park Lane em Bordô escuro — close-up de punhos largos com abotoaduras Monogram Bint Saeed douradas removíveis sobre crepe macio. ${DISCOVERY_TAIL.pt}`,
...
const DARK_MAROON_LIFESTYLE_02_ALTS = altLoc(
  `Bint Saeed Park Lane Abaya in Dark Maroon, full-length lifestyle view with graceful A-line drape, integrated shoulder scarf, and Bint Saeed signature gold-tone Monogram cufflinks in warm architectural light. ${DISCOVERY_TAIL.en}`,
  ...
  `Bint Saeed Park Lane Abaya in Bordeaux scuro, vista lifestyle a tutta lunghezza con drappeggio A-line aggraziato, sciarpa spalla integrata e gemelli Monogram Bint Saeed dorati in luce architettonica calda. ${DISCOVERY_TAIL.it}`,
  `Abaya Bint Saeed Park Lane en Burdeos oscuro, vista lifestyle de largo completo con caída A-line elegante, bufanda de hombro integrada y gemelos Monogram Bint Saeed dorados bajo luz arquitectónica cálida. ${DISCOVERY_TAIL.es}`,
  ...
  `Abaya Bint Saeed Park Lane em Bordô escuro, vista lifestyle de comprimento total com caimento A-line gracioso, lenço de ombro integrado e abotoaduras Monogram Bint Saeed douradas sob luz arquitetónica quente. ${DISCOVERY_TAIL.pt}`,
