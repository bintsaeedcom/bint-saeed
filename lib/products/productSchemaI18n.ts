...
const PROPERTY_LABELS: Record<string, Record<AppLocale, string>> = {
  ...
  'Model wears': {
    en: 'Model wears',
    ar: 'مقاس العارضة',
    fr: 'Taille portée par le mannequin',
    it: 'Taglia indossata dalla modella',
    es: 'Talla que lleva la modelo',
    ru: 'Размер на модели',
    zh: '模特穿着尺码',
    de: 'Modell trägt',
    nl: 'Model draagt',
  ...
  'Emirati heritage': {
    en: 'Emirati heritage',
    ar: 'التراث الإماراتي',
    fr: 'Patrimoine émirati',
    it: 'Patrimonio emiratino',
    es: 'Patrimonio emiratí',
    ru: 'Эмиратское наследие',
    zh: '阿联酋传承',
    de: 'Emiratisches Erbe',
    nl: 'Emiratisch erfgoed',
    pt: 'Património emirati',
    id: 'Warisan Emirati',
    ms: 'Warisan Emirati',
  },
}
