...
const INTRO_BY_LOCALE: Record<AppLocale, PdpIntroParagraph[]> = {
  ...
  zh: [
    ...
    trimParagraph(
      '提供深黑色与海军蓝，每个细节皆经深思熟虑。两件实用胸袋与长裤隐藏侧缝口袋，兼顾日常实用与精致设计。饰以 BINT SAEED 承悦 标志性金色调 ',
      ' 纽扣与沿裤侧优雅延伸的 ',
    ...
    [
      {
        type: 'text',
        value:
          'Al Talli 为联合国教科文组织非物质文化遗产，是阿联酋最受推崇的传统手工艺之一。在 BINT SAEED 承悦，我们通过当代设计重新诠释这一卓越传承。',
      },
    ],
    [
      {
        type: 'text',
        value:
          '无论在阿布扎比、迪拜、多哈、利雅得、科威特城、马斯喀特、伦敦、巴黎、米兰、多伦多或新加坡，Soho 套装体现 BINT SAEED 承悦 以永恒设计传承遗产的理念，伴您优雅出行。',
      },
    ],
  ],
  de: [
