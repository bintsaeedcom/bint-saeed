...
export const GROSVENOR_SET_SCHEMA_AUDIENCE: Record<AppLocale, string> = {
  ...
  zh: '寻求设计师奢华两件套、衬衫半裙套装、缎面晚宴套装、可更换天然石服饰珠宝、及地长裙套装、端庄两件套、Knotted Line 套装及正式场合装与含蓄阿联酋优雅的当代端庄时尚的女性；重视袖口可更换链饰、附赠玛瑙链、缎面垂坠、金色调腰饰、阿布扎比剪裁；海湾、中国大陆、香港、伦敦、巴黎、米兰、利雅得及国际衣橱；婚礼、晚宴、开斋与使馆场合；可整套或分开穿着。寻找奢华礼品的男性。',
