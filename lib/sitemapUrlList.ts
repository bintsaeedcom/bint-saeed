...
const allUrls: SitemapUrlEntry[] = [
  ...
  homePageUrl,
  { loc: `${SITEMAP_BASE_URL}/shop`, lastmod: new Date().toISOString(), changefreq: 'daily', priority: '0.9' },
  { loc: `${SITEMAP_BASE_URL}/accessories`, lastmod: new Date().toISOString(), changefreq: 'daily', priority: '0.9' },
  { loc: `${SITEMAP_BASE_URL}/about`, lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.8' },
  { loc: `${SITEMAP_BASE_URL}/the-codes`, lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.85' },
  ...
  { loc: `${SITEMAP_BASE_URL}/contact`, lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.6' },
  { loc: `${SITEMAP_BASE_URL}/faq`, lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.5' },
  { loc: `${SITEMAP_BASE_URL}/size-guide`, lastmod: new Date().toISOString(), changefreq: 'monthly', priority: '0.6' },
