...
export const THE_CODES_SECTIONS_AR: CodesSectionContent[] = [
  ...
  },
  {
    ...
    paragraphs: [
      'روزيت العين حجر عقيق أحمر منحوت، طُوِّر كزخرف مميّز لدار Bint Saeed.',
      'يستمد لونها الدافئ من المشهد المتغيّر لدولة الإمارات العربية المتحدة. من الرمال الشاحبة على ساحل أبوظبي إلى الدرجات الحمراء الأعمق حول العين، تتبدّل الصحراء في لونها. والعقيق الأحمر يلتقط هذا الطيف بطبيعته، من الكهرمان الدافئ إلى التيراكوتا الغنية.',
      'وهيئتها المستديرة تستلهم نباتات صحراء العين، مستدعيةً زهر الصحراء والزهرة الناعمة البتلات لـ Tribulus omanense، الزهرة الوطنية للإمارات.',
      'تظهر روزيت العين اليوم في مجوهرات مختارة وستراندات هاتف وأغراض صغيرة، حيث تبدأ في ترسيخ رمز دار يُعرف به ويمكن أن يتطوّر عبر Bint Saeed مع الزمن.',
    ],
