...
const AR: GivingForwardCopy = {
  ...
  pillars: [
    {
      title: 'المسؤولية',
      body: 'نخلق استجابةً لما يُراد حقاً، مفضّلاتٍ إنتاجاً مدروساً على الإفراط. ومع نمو الدار، نبقى مسؤولات عما نُدخله إلى العالم وعن الاختيارات وراء كيفية صنعه.',
    },
    {
      title: 'الاستمرارية',
      body: 'نؤمن بأن التراث الإماراتي يستحق أن يستمر بفخر، وأن يجد تعبيراً جديداً في حياة النساء اليوم. متجذّرات في دولة الإمارات العربية المتحدة، نحمل مراجعه الثقافية إلى التصميم المعاصر وعبر الحدود، ليُكتشف في أماكن جديدة دون أن يفقد أصله.',
    },
    {
      title: 'العطاء المستمر',
      body: 'ينبغي أن يخلق النمو إمكانية لشيء أبعد منا أن يتقدّم أيضاً. عبر العطاء الخيري ودعم الآخرين، نؤمن بأن جزءاً مما تتلقاه الدار ينبغي أن يستمر إلى حياة من قد يحتاجونه.',
    },
    {
      title: 'الانتماء',
      body: 'أن تكوني ابنة هو أن تنتمي إلى قصة، ومكان، وإلى من يشكّلون جزءاً من أصلك. تجمع Bint Saeed نساءً يقدّرن الأصل والتراث وحرية حملهما معاً إلى حياة هي لهن بالكامل.',
    },
    {
      title: 'الكرامة',
      body: 'نتعامل مع المرأة والحرفية والتراث الثقافي بالاحترام الذي تستحقه قصصهن. نؤمن بأن هذه القصص ينبغي أن تُصان، ونحتفي بنساء يحملن أنفسهن بكرامة واحترام للذات وفهم عميق لقيمتهن.',
    },
  ],
  shopCta: 'تسوقي القطع',
