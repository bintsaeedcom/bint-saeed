...
const EN: ContactPageCopy = {
  ...
  thankYou: 'Thank you for writing',
...
const FR: ContactPageCopy = {
  ...
  thankYou: 'Merci de nous avoir écrit',
...
const IT: ContactPageCopy = {
  ...
  heroDescription:
    'Che tu stia scoprendo Bint Saeed per la prima volta o faccia già parte della nostra comunità, siamo lieti di assisterti in ogni richiesta.',
  ...
  thankYou: 'Grazie per averci scritto',
  sendAnother: 'Invia un altro messaggio',
  toastBody: 'Grazie per la tua richiesta. Ti risponderemo a breve.',
...
const RU: ContactPageCopy = {
  ...
  thankYou: 'Благодарим за обращение',
...
const PT: ContactPageCopy = {
  ...
  thankYou: 'Obrigado por nos escrever',
...
const ID: ContactPageCopy = {
  ...
  thankYou: 'Terima kasih telah menulis',
...
const MS: ContactPageCopy = {
  ...
  thankYou: 'Terima kasih kerana menulis',
