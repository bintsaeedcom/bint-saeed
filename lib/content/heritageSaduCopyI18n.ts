...
const SADU: Record<AppLocale, Omit<SaduPageCopy, keyof HeritageSharedChrome>> = {
  en: {
    ...
    unescoBody: 'In 2011, Sadu weaving was inscribed on UNESCO\'s List of Intangible Cultural Heritage in Need of Urgent Safeguarding. This recognition emphasized the importance of preserving this traditional art and passing it to future generations.',
    unescoBadge1: 'Inscribed 2011',
    unescoBadge2: 'Urgent Safeguarding',
  ...
  ar: {
    ...
    unescoBody: 'في عام 2011، أُدرج السدو على قائمة اليونسكو للتراث الثقافي غير المادي الذي يحتاج إلى صون عاجل. هذا الاعتراف أكد على أهمية الحفاظ على هذا الفن التقليدي ونقله للأجيال القادمة.',
    unescoBadge1: 'مُدرج 2011',
    unescoBadge2: 'صون عاجل',
  ...
  fr: {
    ...
    unescoBody: 'En 2011, le tissage Sadu a été inscrit sur la Liste du patrimoine culturel immatériel nécessitant une sauvegarde urgente de l’UNESCO. Cette reconnaissance souligne l’importance de préserver cet art et de le transmettre.',
    unescoBadge1: 'Inscrit 2011',
    unescoBadge2: 'Sauvegarde urgente',
  ...
  it: {
    ...
    unescoBody: 'Nel 2011 la tessitura Sadu è stata iscritta nella Lista del patrimonio culturale immateriale che necessita di salvaguardia urgente dell’UNESCO. Questo riconoscimento sottolinea l’importanza di preservare quest’arte e tramandarla.',
    unescoBadge1: 'Iscritto 2011',
    unescoBadge2: 'Salvaguardia urgente',
  ...
  es: {
    ...
    unescoBody: 'En 2011, el tejido Sadu fue inscrito en la Lista del patrimonio cultural inmaterial que requiere salvaguarda urgente de la UNESCO. Este reconocimiento subrayó la importancia de preservar este arte y transmitirlo.',
    unescoBadge1: 'Inscrito 2011',
    unescoBadge2: 'Salvaguarda urgente',
    unescoBadge3: 'EAU • KSA • Kuwait',
  ...
  ru: {
    ...
    unescoBody: 'В 2011 году ткачество Sadu было внесено в Список нематериального культурного наследия ЮНЕСКО, нуждающегося в срочной охране. Это признание подчеркнуло важность сохранения искусства и передачи его дальше.',
    unescoBadge1: 'Внесён 2011',
    unescoBadge2: 'Срочная охрана',
  ...
  zh: {
    ...
    unescoEyebrow: '全球认可',
    unescoTitle: '为世代保存',
    unescoBody: '2011 年，Sadu 编织被列入联合国教科文组织急需保护的非物质文化遗产名录。这一认可强调了保存并传承这一传统艺术的重要性。',
  ...
  de: {
    ...
    unescoBody: '2011 wurde Sadu-Weberei in die UNESCO-Liste des immateriellen Kulturerbes aufgenommen, das dringend der Sicherung bedarf. Diese Anerkennung unterstreicht die Bedeutung, diese Kunst zu bewahren und weiterzugeben.',
    unescoBadge1: 'Eingetragen 2011',
    unescoBadge2: 'Dringende Sicherung',
  ...
  nl: {
    ...
    unescoBody: 'In 2011 werd Sadu-weven opgenomen op de UNESCO-lijst van immaterieel cultureel erfgoed dat dringend bescherming nodig heeft. Deze erkenning onderstreept het belang om deze kunst te bewaren en door te geven.',
    unescoBadge1: 'Ingeschreven 2011',
    unescoBadge2: 'Dringende bescherming',
  ...
  pt: {
    ...
    unescoBody: 'Em 2011, a tecelagem Sadu foi inscrita na Lista do património cultural imaterial que necessita de salvaguarda urgente da UNESCO. Este reconhecimento sublinhou a importância de preservar esta arte e transmiti-la.',
    unescoBadge1: 'Inscrito 2011',
    unescoBadge2: 'Salvaguarda urgente',
    unescoBadge3: 'EAU • KSA • Kuwait',
  ...
  id: {
    ...
    unescoBody: 'Pada 2011, tenun Sadu dicatat dalam Daftar Warisan Budaya Takbenda UNESCO yang memerlukan perlindungan mendesak. Pengakuan ini menekankan pentingnya melestarikan seni ini dan mewariskannya.',
    unescoBadge1: 'Dicatat 2011',
    unescoBadge2: 'Perlindungan mendesak',
  ...
  ms: {
    ...
    unescoBody: 'Pada 2011, tenunan Sadu disenaraikan dalam Senarai Warisan Budaya Tidak Ketara UNESCO yang memerlukan perlindungan segera. Pengiktirafan ini menekankan kepentingan memelihara seni ini dan mewariskannya.',
    unescoBadge1: 'Disenaraikan 2011',
    unescoBadge2: 'Perlindungan segera',
    unescoBadge3: 'UAE • KSA • Kuwait',
    paletteEyebrow: 'Palet',
    paletteTitle: 'Warna Sadu',
    colors: [
