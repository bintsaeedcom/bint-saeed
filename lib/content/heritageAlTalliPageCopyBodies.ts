...
export const AL_TALLI_PAGE_COPY_BODIES: Record<AppLocale, AlTalliPageCopyBody> = {
  ...
  ar: {
    ...
    imageAltHero:
      'كجوجة التلي بشريط ذهبي وبكرات خشبية في عرض تراثي, أبوظبي',
    ...
    imageTitleHero:
      'كجوجة التلي بالبكرات الذهبية, حرفة تراثية إماراتية في أبوظبي',
  ...
  zh: {
    ...
    imageAltHero:
      '展示中的 Al Talli kajujah 金饰带与木线轴, 阿布扎比',
    ...
    imageTitleHero:
      '带金线轴的 Al Talli kajujah, 阿布扎比传承工艺',
