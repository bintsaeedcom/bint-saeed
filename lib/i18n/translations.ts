...
export const translations = {
  en: {
    ...
    marquee: {
      ...
      freeShipping: 'Complimentary UAE Shipping From AED 1,000 · Worldwide From EUR 500',
    ...
    product: {
      ...
      sizeMeasurements: 'Size & Fit',
      origin: 'Origin',
      shippingReturns: 'Shipping & Returns',
      freeShipping: 'Complimentary UAE shipping from AED 1,000 · worldwide from EUR 500',
      expressDelivery: 'Express delivery: 1-2 business days (UAE)',
      standardDelivery: 'Standard delivery: 3-5 business days (GCC)',
      returns: 'All sales are final. Exchanges for in-stock items accepted within 14 days (conditions apply)',
    ...
    cart: {
      ...
      total: 'Total',
      proceedToCheckout: 'Review Your Order',
      freeShippingNote: 'Complimentary UAE shipping from AED 1,000 · worldwide from EUR 500',
  ...
  ar: {
    ...
    marquee: {
      ...
      freeShipping: 'شحن مجاني داخل الإمارات من 1,000 درهم · وعالمياً من 500 يورو',
    ...
    product: {
      ...
      sizeMeasurements: 'المقاس والملاءمة',
      origin: 'المنشأ',
      ...
      returns: 'جميع المبيعات نهائية. يُقبل الاستبدال خلال 14 يوم (تطبق الشروط)',
    ...
    cart: {
      ...
      complimentary: 'مجاني',
      total: 'الإجمالي',
      proceedToCheckout: 'راجعي طلبك',
      freeShippingNote: 'شحن مجاني داخل الإمارات من 1,000 درهم · وعالمياً من 500 يورو',
    ...
    comingSoon: {
      tagline: 'قريباً، يُكشف المزيد',
      aboutTitle: 'من نحن',
      aboutSubtitle: 'بيت صاغته الأصول، وحمل عبر العالم.',
      aboutP1:
      ...
      gazellesAlt: 'غزلان',
      thankYou: 'شكراً لكِ.',
      notifyWhenLaunch: 'سنُعلمكِ عند الإطلاق.',
      formHeading: 'كوني أول من يعلم.',
      emailPlaceholder: 'أدخلي بريدك الإلكتروني',
      emailEmpty: 'الرجاء إدخال بريدك الإلكتروني',
  ...
  fr: {
    ...
    marquee: {
      ...
      freeShipping: 'Livraison offerte EAU dès 1 000 AED · Monde dès 500 EUR',
    ...
    cart: {
      ...
      freeShippingNote: 'Livraison offerte EAU dès 1 000 AED · monde dès 500 EUR',
  ...
  it: {
    ...
    marquee: {
      newArrivals: 'Novità',
      freeShipping: 'Spedizione gratuita EAU da 1.000 AED · Mondo da 500 EUR',
    ...
    product: {
      ...
      sizeMeasurements: 'Taglia & Vestibilità',
      origin: 'Origine',
    ...
    cart: {
      ...
      freeShippingNote: 'Spedizione gratuita EAU da 1.000 AED · mondo da 500 EUR',
  ...
  es: {
    ...
    marquee: {
      ...
      freeShipping: 'Envío gratuito EAU desde 1.000 AED · Mundial desde 500 EUR',
    ...
    product: {
      ...
      sizeMeasurements: 'Talla y Ajuste',
      origin: 'Origen',
    ...
    cart: {
      ...
      freeShippingNote: 'Envío gratuito EAU desde 1.000 AED · mundial desde 500 EUR',
  ...
  ru: {
    ...
    marquee: {
      newArrivals: 'Новинки',
      freeShipping: 'Бесплатная доставка ОАЭ от 1 000 AED · мир от 500 EUR',
    ...
    product: {
      ...
      sizeMeasurements: 'Размер и посадка',
    ...
    cart: {
      ...
      freeShippingNote: 'Бесплатная доставка ОАЭ от 1 000 AED · мир от 500 EUR',
  ...
  zh: {
    ...
    marquee: {
      newArrivals: '新品上市',
      freeShipping: '阿联酋满1,000迪拉姆免运费 · 全球满500欧元免运费',
    ...
    cart: {
      ...
      freeShippingNote: '阿联酋满1,000迪拉姆免运费 · 全球满500欧元免运费',
      securePayment: '安全支付',
      processing: '处理中...',
    },
    footer: {
  ...
  de: {
    ...
    marquee: {
      ...
      freeShipping: 'Kostenloser UAE-Versand ab 1.000 AED · Weltweit ab 500 EUR',
    ...
    product: {
      ...
      sizeMeasurements: 'Größe & Passform',
      origin: 'Herkunft',
    ...
    cart: {
      ...
      freeShippingNote: 'Kostenloser UAE-Versand ab 1.000 AED · Weltweit ab 500 EUR',
...
export type Language = 'en' | 'ar' | 'fr' | 'it' | 'es' | 'ru' | 'zh' | 'de' | 'nl' | 'pt' | 'id' | 'ms'
...
export const seoKeywords = {
  ...
  ar: [
    ...
    'عبايات دبي',
    'أزياء شرق أوسطية',
    'ماذا ترتدين في الشرق الأوسط',
    'ماذا ترتدين في دبي',
    'ماذا ترتدين في أبوظبي',
  ],
  fr: [
    'abaya de luxe',
    'abaya Abu Dhabi',
