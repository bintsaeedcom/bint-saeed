...
const EN: SearchableItem[] = [
  ...
  { title: 'Abaya Strands', href: '/strands#shop-all-strands', category: 'Accessories' },
...
const AR: SearchableItem[] = [
  ...
  { title: 'خيوط العباءة', href: '/strands#shop-all-strands', category: 'إكسسوارات' },
  ...
  { title: 'أساور', href: '/accessories?type=bracelets', category: 'إكسسوارات' },
