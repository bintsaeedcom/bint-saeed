...
const EXACT_ALTS: Record<string, string> = {
  "Mayfair Kaftan in Deep Maroon crepe chiffon, pandangan hadapan. Luxury women's occasion kaftan by Bint Saeed Abu Dhabi, United Arab Emirates, featuring a V-neckline, flowing silhouette, attached scarf butiran and signature gold-tone emblem.":
  ...
  "Nothing Hill Kaftan in Peach Pink chiffon, pandangan hadapan. Luxury women's occasion kaftan by Bint Saeed Abu Dhabi, United Arab Emirates, featuring a bateau neckline, flowing silhouette and signature gold-tone emblem.":
  ...
  'Nothing Hill Kaftan in Peach Pink chiffon, pandangan dekat. Designer chiffon kaftan by Bint Saeed Abu Dhabi, United Arab Emirates, showcasing soft peach pink chiffon fabric, delicate layered texture and the signature gold-tone Bint Saeed emblem pin.':
