...
type CommerceUiCart = {
  ...
  /** Use {amount} for the UAE complimentary threshold in the visitor currency. */
  freeUaeShipping: string
  /** Use {amount} for the worldwide complimentary threshold in the visitor currency. */
...
type CommerceUiCheckout = {
  ...
  /** Apparel / made-to-order garments on Review Your Order. */
  leadTimeFashion: string
  /** Jewellery-only bags on Review Your Order. */
  leadTimeJewellery: string
  /** Mixed garment + jewellery bags. */
...
type CommerceUiQuickBuy = {
  ...
  added: string
  buyNow: string
  /** Divider above Apple Pay / Google Pay when wallets are available. */
  expressOr: string
}
...
const COMMERCE_UI: Record<AppLocale, CommerceUi> = {
  en: {
    ...
    cart: {
      ...
      shippingComplimentaryUae: 'Complimentary UAE shipping applies for delivery within the UAE.',
      shippingLabel: 'Shipping',
      shippingComplimentaryShort: 'Complimentary',
      intlShippingNote: 'Shipping below these thresholds is confirmed at payment.',
      deliveryAtPayment: 'Shipping is confirmed at payment.',
    },
    checkout: {
      ...
      leadTimeFashion: 'Ordered, crafted for you then delivered · ships in 10–14 days',
      leadTimeJewellery: 'Ordered, crafted for you then delivered · ships in 4–7 days',
      leadTimeMixed: 'Garments ship in 10–14 days · jewellery in 4–7 days',
    ...
    accessories: {
      ...
      materials: 'Materials',
      careBullets: [
        'Handle with care. Natural gemstones may chip or break if struck or dropped.',
        'Avoid perfume, water, chlorine and harsh chemicals. Bathe and apply lotion before wearing.',
        'Wipe gently with a soft, dry cloth. Do not soak natural stones.',
        'Store separately in a soft pouch or Bint Saeed gift box, away from sunlight, heat and damp.',
      ],
      oneSize: 'One Size',
    ...
    footer: {
      ...
      givingForwardDesc: '20 AED from each item sold is dedicated to charity.',
    ...
    deliveryBanner: {
      uaeFree: 'Complimentary UAE Shipping Above {amount} • Delivery in 2 Weeks',
      worldwide: 'Complimentary Worldwide Shipping Above {amount}',
  ...
  ar: {
    ...
    cart: {
      ...
      freeUaeShipping: 'شحن مجاني داخل الإمارات للطلبات فوق {amount}',
      freeWorldwideShipping: 'شحن مجاني عالمياً للطلبات فوق {amount}',
      shippingComplimentary: 'الشحن المجاني عالمياً مشمول مع هذا الاختيار.',
      shippingComplimentaryUae: 'ينطبق الشحن المجاني داخل الإمارات على التوصيل داخل الدولة.',
      shippingLabel: 'الشحن',
      shippingComplimentaryShort: 'مجاني',
      intlShippingNote: 'تُؤكد رسوم الشحن دون هذه العتبات عند الدفع.',
      deliveryAtPayment: 'يُؤكد الشحن عند الدفع.',
    },
    checkout: {
      ...
      leadTimeFashion: 'تُطلب، تُصنع لأجلكِ، ثم تُسلَّم · تُشحن خلال 10–14 يوماً',
      leadTimeJewellery: 'تُطلب، تُصنع لأجلكِ، ثم تُسلَّم · تُشحن خلال 4–7 أيام',
      leadTimeMixed: 'الملابس تُشحن خلال 10–14 يوماً · المجوهرات خلال 4–7 أيام',
    ...
    accessories: {
      ...
      materials: 'الخامات',
      careBullets: [
        'تعاملي بعناية. الأحجار الطبيعية قد تتشقّق أو تنكسر إذا ضُربت أو سقطت.',
        'تجنّبي العطر والماء والكلور والمواد الكيميائية القاسية. استحمّي وضعي المستحضرات قبل الارتداء.',
        'امسحي بلطف بقطعة قماش ناعمة وجافة. لا تغمري الأحجار الطبيعية.',
        'احفظي بشكل منفصل في جراب ناعم أو علبة هدايا Bint Saeed، بعيداً عن الشمس والحرارة والرطوبة.',
      ],
      oneSize: 'مقاس واحد',
    ...
    footer: {
      ...
      deliveredGlobally: 'شحن مجاني عالمياً فوق {amount}.',
      freeUaeShippingTitle: 'شحن مجاني داخل الإمارات',
      freeUaeShippingDesc: 'توصيل مجاني للطلبات فوق {amount}.',
      craftedToOrderTitle: 'يُصنع حسب الطلب',
      craftedToOrderDesc: 'كل قطعة تُحضّر بعناية ودقة.',
      givingForwardTitle: 'العطاء المستمر',
      givingForwardDesc: 'يُخصَّص 20 درهماً من كل قطعة للأعمال الخيرية.',
    ...
    deliveryBanner: {
      uaeFree: 'شحن مجاني داخل الإمارات فوق {amount} • توصيل خلال أسبوعين',
      worldwide: 'شحن مجاني عالمياً فوق {amount}',
  ...
  fr: {
    ...
    shop: {
      ...
      noPiecesInChapter: 'Aucune pièce dans ce chapitre pour le moment.',
      categoryAll: 'Tous',
      categories: {
        All: 'Tous',
        Abayas: 'Abayas',
    ...
    cart: {
      ...
      emptyDescription: 'Découvrez notre collection et trouvez les pièces qui vous ressemblent.',
      ...
      note: 'Note',
      proceedSecurePayment: 'Passer au paiement sécurisé',
      shipWorldwide: 'Livraison dans le monde entier',
      freeUaeShipping: 'Livraison offerte aux ÉAU pour les commandes au-dessus de {amount}',
      freeWorldwideShipping: 'Livraison offerte dans le monde pour les commandes au-dessus de {amount}',
      shippingComplimentary: 'La livraison mondiale offerte est incluse avec cette sélection.',
      shippingComplimentaryUae: 'La livraison offerte aux EAU s’applique pour une livraison aux Émirats.',
      shippingLabel: 'Livraison',
      shippingComplimentaryShort: 'Offerte',
      intlShippingNote: 'Les frais sous ces seuils sont confirmés au paiement.',
      deliveryAtPayment: 'La livraison est confirmée au paiement.',
    },
    checkout: {
      securePayment: 'Paiement sécurisé',
      editBag: 'Modifier le panier',
      reviewOrder: 'Vérifiez votre commande',
      reviewSubtitle: 'Vérifiez votre sélection avant de passer au paiement sécurisé.',
      leadTimeFashion: 'Commandée, confectionnée pour vous, puis livrée · expédiée sous 10 à 14 jours',
      leadTimeJewellery: 'Commandée, confectionnée pour vous, puis livrée · expédiée sous 4 à 7 jours',
      leadTimeMixed: 'Les pièces vestimentaires sous 10 à 14 jours · la joaillerie sous 4 à 7 jours',
      redirecting: 'Redirection...',
      continueSecurePayment: 'Continuer vers le paiement sécurisé',
      legalAcceptPrefix: 'J’ai lu et j’accepte la',
      shipmentPolicy: 'Politique de livraison et de retour',
      legalAnd: 'et les',
      termsConditions: 'Conditions générales',
      legalRequired: 'Veuillez accepter la Politique de livraison et de retour ainsi que les Conditions générales',
      checkoutError: 'Impossible de lancer le paiement. Veuillez réessayer.',
      stripeNotConfigured: 'Le paiement Stripe n’est pas configuré pour cet environnement.',
      stripeEnvHint: 'Définissez NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY et STRIPE_SECRET_KEY pour activer le paiement.',
    ...
    accessories: {
      ...
      collectionIntro:
        'Parcourez les signature strands, colliers, boucles d’oreilles, breloques sac et breloques téléphone. Filtrez par catégorie, prix, couleur et pierre.',
      collectionEyebrow: 'Collection',
      backToHome: "Retour à l'accueil",
      filter: 'Filtrer',
      products: 'Produits',
      ...
      materials: 'Materiaux',
      careBullets: [
        'Manipulez avec précaution. Les pierres naturelles peuvent s’ébrécher ou se briser en cas de choc ou de chute.',
        'Évitez le parfum, l’eau, le chlore et les produits chimiques agressifs. Baignez-vous et appliquez vos soins avant le port.',
        'Essuyez délicatement avec un chiffon doux et sec. N’immergez pas les pierres naturelles.',
        'Rangez séparément dans une pochette douce ou un écrin Bint Saeed, à l’abri du soleil, de la chaleur et de l’humidité.',
      ],
    ...
    footer: {
      ...
      deliveredGlobally: 'Livraison mondiale offerte au-dessus de {amount}.',
      freeUaeShippingTitle: 'Livraison offerte aux EAU',
      freeUaeShippingDesc: 'Livraison offerte pour les commandes au-dessus de {amount}.',
      ...
      givingForwardDesc: '20 AED de chaque article vendu sont dédiés à la charité.',
      newsletter: 'Newsletter',
    ...
    deliveryBanner: {
      uaeFree: 'Livraison offerte aux EAU au-dessus de {amount} • Livraison sous 2 semaines',
      worldwide: 'Livraison mondiale offerte au-dessus de {amount}',
    ...
    quickBuy: {
      ...
      expressOr: 'Ou payer instantanément',
    },
    miniCart: {
  ...
  de: {
    ...
    shop: {
      ...
      openProduct: 'Öffne {name}',
      noPiecesInChapter: 'Noch keine Stücke in diesem Kapitel.',
      categoryAll: 'Alle',
      categories: {
        All: 'Alle',
        Abayas: 'Abayas',
    ...
    cart: {
      ...
      emptyDescription: 'Entdecken Sie unsere Kollektion und finden Sie Stücke, die zu Ihnen passen.',
      shopNow: 'Jetzt shoppen',
      continueShopping: 'Weiter einkaufen',
      orderSummary: 'Bestellübersicht',
      subtotal: 'Zwischensumme',
      estimatedTotal: 'Gesamtsumme (geschätzt)',
      ...
      freeUaeShipping: 'Kostenloser UAE-Versand bei Bestellungen über {amount}',
      freeWorldwideShipping: 'Kostenloser weltweiter Versand bei Bestellungen über {amount}',
      shippingComplimentary: 'Kostenloser weltweiter Versand ist in dieser Auswahl enthalten.',
      shippingComplimentaryUae: 'Kostenloser UAE-Versand gilt für Lieferungen innerhalb der VAE.',
      shippingLabel: 'Versand',
      shippingComplimentaryShort: 'Kostenlos',
      intlShippingNote: 'Versandkosten unter diesen Schwellen werden bei der Zahlung bestätigt.',
      deliveryAtPayment: 'Versand wird bei der Zahlung bestätigt.',
    },
    checkout: {
      securePayment: 'Sichere Zahlung',
      editBag: 'Tasche bearbeiten',
      reviewOrder: 'Bestellung prüfen',
      reviewSubtitle: 'Prüfen Sie Ihre Auswahl vor der sicheren Zahlung.',
      leadTimeFashion: 'Bestellt, für Sie gefertigt, dann geliefert · Versand in 10–14 Tagen',
      leadTimeJewellery: 'Bestellt, für Sie gefertigt, dann geliefert · Versand in 4–7 Tagen',
      leadTimeMixed: 'Bekleidung in 10–14 Tagen · Schmuck in 4–7 Tagen',
      redirecting: 'Weiterleitung...',
      continueSecurePayment: 'Weiter zur sicheren Zahlung',
      legalAcceptPrefix: 'Ich habe gelesen und akzeptiere die',
      shipmentPolicy: 'Versand- und Rückgaberichtlinie',
      legalAnd: 'und die',
      termsConditions: 'AGB',
      legalRequired: 'Bitte akzeptieren Sie die Versand- und Rückgaberichtlinie sowie die AGB',
      checkoutError: 'Checkout konnte nicht gestartet werden. Bitte erneut versuchen.',
      stripeNotConfigured: 'Stripe Checkout ist für diese Umgebung noch nicht konfiguriert.',
      ...
      continueWithTamara: 'Weiter mit Tamara',
    },
    accessories: {
      collectionTitle: 'Accessoires',
      collectionIntro:
        'Entdecken Sie Signature Strands, Halsketten, Ohrringe, Armbänder, Taschen- und Handyanhänger. Filtern Sie nach Kategorie, Preis, Farbe und Stein.',
      collectionEyebrow: 'Kollektion',
      backToHome: 'Zur Startseite',
      filter: 'Filtern',
      products: 'Produkte',
      ...
      careBullets: [
        ...
        'Vorsichtig mit einem trockenen, weichen Tuch reinigen. Natursteine nicht einweichen.',
      ],
    ...
    footer: {
      ...
      deliveredGlobally: 'Kostenloser weltweiter Versand ab {amount}.',
      freeUaeShippingTitle: 'Kostenloser UAE-Versand',
      freeUaeShippingDesc: 'Kostenlose Lieferung bei Bestellungen über {amount}.',
      craftedToOrderTitle: 'Auf Bestellung gefertigt',
      craftedToOrderDesc: 'Jedes Stück wird mit Sorgfalt und Präzision vorbereitet.',
      givingForwardTitle: 'Wir geben weiter',
      givingForwardDesc: '20 AED je verkauftem Stück gehen an wohltätige Zwecke.',
      newsletter: 'Newsletter',
    ...
    deliveryBanner: {
      uaeFree: 'Kostenloser UAE-Versand ab {amount} • Lieferung in 2 Wochen',
      worldwide: 'Kostenloser weltweiter Versand ab {amount}',
    ...
    quickBuy: {
      ...
      added: 'Hinzugefugt!',
      buyNow: 'Jetzt kaufen',
      expressOr: 'Oder sofort bezahlen',
    },
    miniCart: {
  ...
  it: {
    ...
    cart: {
      shoppingBag: 'Shopping bag',
      empty: 'La tua shopping bag è vuota',
      ...
      freeUaeShipping: 'Spedizione gratuita negli EAU per ordini superiori a {amount}',
      freeWorldwideShipping: 'Spedizione gratuita mondiale per ordini superiori a {amount}',
      shippingComplimentary: 'La spedizione mondiale gratuita è inclusa in questa selezione.',
      shippingComplimentaryUae: 'La spedizione gratuita negli EAU si applica per consegne negli Emirati.',
      shippingLabel: 'Spedizione',
      shippingComplimentaryShort: 'Gratuita',
      intlShippingNote: 'Le spese sotto queste soglie sono confermate al pagamento.',
      deliveryAtPayment: 'La spedizione è confermata al pagamento.',
    },
    checkout: {
      ...
      leadTimeFashion: 'Ordinata, realizzata per voi, poi consegnata · spedizione in 10–14 giorni',
      leadTimeJewellery: 'Ordinata, realizzata per voi, poi consegnata · spedizione in 4–7 giorni',
      leadTimeMixed: 'Abbigliamento in 10–14 giorni · gioielli in 4–7 giorni',
      ...
      stripeNotConfigured: 'Stripe checkout non è configurato per questo ambiente.',
      ...
      continueWithTamara: 'Continua con Tamara',
    },
    accessories: {
      ...
      materials: 'Materiali',
      careBullets: [
        'Maneggiate con cura. Le pietre naturali possono scheggiarsi o rompersi se urtate o fatte cadere.',
        'Riponi in una custodia morbida dopo l uso.',
        'Evita profumo, acqua e sostanze chimiche aggressive.',
        'Pulisci delicatamente con un panno morbido e asciutto. Non immergere le pietre naturali.',
      ],
    ...
    footer: {
      ...
      deliveredGlobally: 'Spedizione mondiale gratuita oltre {amount}.',
      freeUaeShippingTitle: 'Spedizione gratuita negli EAU',
      freeUaeShippingDesc: 'Consegna gratuita per ordini superiori a {amount}.',
      ...
      givingForwardDesc: '20 AED da ogni articolo venduto sono destinati alla beneficenza.',
      newsletter: 'Newsletter',
    ...
    deliveryBanner: {
      uaeFree: 'Spedizione gratuita negli EAU oltre {amount} • Consegna in 2 settimane',
      worldwide: 'Spedizione mondiale gratuita oltre {amount}',
    ...
    quickBuy: {
      ...
      added: 'Aggiunto!',
      buyNow: 'Acquista ora',
      expressOr: 'O paga subito',
    },
    miniCart: {
      yourBagIsEmpty: 'La tua shopping bag è vuota',
  ...
  es: {
    ...
    cart: {
      ...
      freeUaeShipping: 'Envío gratuito en EAU en pedidos superiores a {amount}',
      freeWorldwideShipping: 'Envío gratuito mundial en pedidos superiores a {amount}',
      shippingComplimentary: 'El envío mundial gratuito está incluido con esta selección.',
      shippingComplimentaryUae: 'El envío gratuito en EAU aplica para entregas dentro de los Emiratos.',
      shippingLabel: 'Envío',
      shippingComplimentaryShort: 'Gratuito',
      intlShippingNote: 'Los gastos por debajo de estos umbrales se confirman en el pago.',
      deliveryAtPayment: 'El envío se confirma en el pago.',
    },
    checkout: {
      ...
      leadTimeFashion: 'Pedida, confeccionada para usted, luego entregada · envío en 10–14 días',
      leadTimeJewellery: 'Pedida, confeccionada para usted, luego entregada · envío en 4–7 días',
      leadTimeMixed: 'Prendas en 10–14 días · joyería en 4–7 días',
    ...
    accessories: {
      ...
      careBullets: [
        'Manipule con cuidado. Las piedras naturales pueden astillarse o romperse si se golpean o caen.',
        'Guarda la pieza en una bolsa suave despues de usarla.',
        'Evita perfume, agua y quimicos agresivos.',
        'Limpia suavemente con un pano seco y suave. No sumerja las piedras naturales.',
      ],
      oneSize: 'Talla unica',
    ...
    footer: {
      ...
      deliveredGlobally: 'Envío mundial gratuito a partir de {amount}.',
      freeUaeShippingTitle: 'Envio gratuito en EAU',
      freeUaeShippingDesc: 'Entrega gratuita en pedidos superiores a {amount}.',
      ...
      givingForwardDesc: '20 AED de cada artículo vendido se destinan a causas benéficas.',
      newsletter: 'Newsletter',
    ...
    deliveryBanner: {
      uaeFree: 'Envío gratuito en EAU a partir de {amount} • Entrega en 2 semanas',
      worldwide: 'Envío mundial gratuito a partir de {amount}',
  ...
  ru: {
    ...
    cart: {
      ...
      freeUaeShipping: 'Бесплатная доставка по ОАЭ при заказе от {amount}',
      freeWorldwideShipping: 'Бесплатная международная доставка при заказе от {amount}',
      shippingComplimentary: 'Бесплатная международная доставка включена в этот выбор.',
      shippingComplimentaryUae: 'Бесплатная доставка по ОАЭ действует для доставки внутри ОАЭ.',
      shippingLabel: 'Доставка',
      shippingComplimentaryShort: 'Бесплатно',
      intlShippingNote: 'Стоимость ниже этих порогов подтверждается при оплате.',
      deliveryAtPayment: 'Доставка подтверждается при оплате.',
    },
    checkout: {
      ...
      leadTimeFashion: 'Заказано, создано для вас, затем доставлено · отправка за 10–14 дней',
      leadTimeJewellery: 'Заказано, создано для вас, затем доставлено · отправка за 4–7 дней',
      leadTimeMixed: 'Одежда за 10–14 дней · украшения за 4–7 дней',
    ...
    accessories: {
      ...
      materials: 'Материалы',
      careBullets: [
        'Обращайтесь бережно. Натуральные камни могут сколоться или сломаться при ударе или падении.',
        'Храните изделие в мягком чехле после носки.',
        'Избегайте контакта с парфюмом, водой и агрессивной химией.',
        'Аккуратно очищайте сухой мягкой тканью. Не замачивайте натуральные камни.',
      ],
    ...
    footer: {
      ...
      deliveredGlobally: 'Бесплатная международная доставка от {amount}.',
      freeUaeShippingTitle: 'Бесплатная доставка по ОАЭ',
      freeUaeShippingDesc: 'Бесплатная доставка при заказе от {amount}.',
      ...
      givingForwardDesc: '20 дирхамов с каждой проданной вещи идут на благотворительность.',
      newsletter: 'Рассылка',
    ...
    deliveryBanner: {
      uaeFree: 'Бесплатная доставка по ОАЭ от {amount} • Доставка за 2 недели',
      worldwide: 'Бесплатная международная доставка от {amount}',
  ...
  zh: {
    ...
    cart: {
      ...
      shipWorldwide: '全球配送',
      freeUaeShipping: '订单满 {amount} 阿联酋境内免运费',
      freeWorldwideShipping: '订单满 {amount} 全球免运费',
      shippingComplimentary: '此选择已含全球免运费。',
      shippingComplimentaryUae: '阿联酋境内配送可享免运费。',
      shippingLabel: '运费',
      shippingComplimentaryShort: '免运费',
      intlShippingNote: '未达门槛的运费将在付款时确认。',
      deliveryAtPayment: '运费将在付款时确认。',
    },
    checkout: {
      securePayment: '安全支付',
      editBag: '编辑购物袋',
      ...
      leadTimeFashion: '下单后专为您制作，再行送达 · 10–14 天内发货',
      leadTimeJewellery: '下单后专为您制作，再行送达 · 4–7 天内发货',
      leadTimeMixed: '服装 10–14 天发货 · 珠宝 4–7 天发货',
      redirecting: '正在跳转...',
    ...
    deliveryBanner: {
      uaeFree: '满 {amount} 阿联酋免运费 • 两周内送达',
      worldwide: '满 {amount} 全球免运费',
  ...
  nl: {
    ...
    cart: {
      ...
      empty: 'Uw tas is leeg',
      emptyDescription: 'Ontdek onze collectie en vind stukken die bij u passen.',
      shopNow: 'Shop nu',
      ...
      freeUaeShipping: 'Gratis verzending in de VAE bij bestellingen boven {amount}',
      freeWorldwideShipping: 'Gratis wereldwijde verzending bij bestellingen boven {amount}',
      shippingComplimentary: 'Gratis wereldwijde verzending is inbegrepen bij deze selectie.',
      shippingComplimentaryUae: 'Gratis VAE-verzending geldt voor levering binnen de VAE.',
      shippingLabel: 'Verzending',
      shippingComplimentaryShort: 'Gratis',
      intlShippingNote: 'Verzendkosten onder deze drempels worden bij betaling bevestigd.',
      deliveryAtPayment: 'Verzending wordt bij betaling bevestigd.',
    },
    checkout: {
      securePayment: 'Veilige betaling',
      editBag: 'Tas bewerken',
      reviewOrder: 'Controleer uw bestelling',
      reviewSubtitle: 'Controleer uw selectie voordat u veilig afrekent.',
      leadTimeFashion: 'Besteld, voor u gemaakt, daarna geleverd · verzending binnen 10–14 dagen',
      leadTimeJewellery: 'Besteld, voor u gemaakt, daarna geleverd · verzending binnen 4–7 dagen',
      leadTimeMixed: 'Kleding binnen 10–14 dagen · sieraden binnen 4–7 dagen',
      ...
      continueWithTamara: 'Doorgaan met Tamara',
    },
    accessories: {
      collectionTitle: 'Accessoires',
      collectionIntro:
        'Ontdek Signature Strands, kettingen, oorbellen, armbanden, tashangers en luxe telefoonhangers. Filter op categorie, prijs, kleur en steen.',
      collectionEyebrow: 'Collectie',
      backToHome: 'Terug naar home',
      filter: 'Filter',
      products: 'Producten',
      ...
      careBullets: [
        'Behandel met zorg. Natuurlijke stenen kunnen afbrokkelen of breken bij stoten of vallen.',
        'Bewaar na gebruik in een zacht zakje.',
        'Vermijd parfum, water en agressieve chemicaliën.',
        'Reinig voorzichtig met een droge, zachte doek. Dompel natuurlijke stenen niet onder.',
      ],
      oneSize: 'One size',
    ...
    footer: {
      ...
      deliveredGlobally: 'Gratis wereldwijde verzending vanaf {amount}.',
      freeUaeShippingTitle: 'Gratis verzending in de VAE',
      freeUaeShippingDesc: 'Gratis levering bij bestellingen boven {amount}.',
      ...
      givingForwardDesc: '20 AED per verkocht stuk gaat naar goede doelen.',
    ...
    account: {
      ...
      signIn: 'Inloggen',
      signInDesc: 'Log in om uw bestellingen en opgeslagen gegevens te bekijken.',
      registerDesc: 'Maak een account voor een snellere en persoonlijkere checkout.',
      forgotPassword: 'Wachtwoord vergeten',
      forgotPasswordDesc: 'Vul uw e-mailadres in en we sturen een link om uw wachtwoord opnieuw in te stellen.',
      resetPassword: 'Wachtwoord opnieuw instellen',
      resetPasswordDesc: 'Kies een nieuw wachtwoord voor uw Bint Saeed-account.',
    },
    notFound: {
      title: 'Pagina niet gevonden',
      description: 'De pagina die u zoekt is mogelijk verplaatst of bestaat niet meer.',
      backToHome: 'Terug naar home',
    ...
    deliveryBanner: {
      uaeFree: 'Gratis VAE-verzending vanaf {amount} • Levering binnen 2 weken',
      worldwide: 'Gratis wereldwijde verzending vanaf {amount}',
  ...
  pt: {
    ...
    shop: {
      ...
      openProduct: 'Abrir {name}',
      noPiecesInChapter: 'Ainda não há peças neste capítulo.',
      categoryAll: 'Todos',
      categories: {
        All: 'Todos',
        Abayas: 'Abayas',
    ...
    cart: {
      ...
      emptyDescription: 'Descubra a nossa coleção e encontre peças com a sua identidade.',
      ...
      freeUaeShipping: 'Envio gratuito nos EAU para encomendas acima de {amount}',
      freeWorldwideShipping: 'Envio gratuito mundial para encomendas acima de {amount}',
      shippingComplimentary: 'O envio mundial gratuito está incluído nesta seleção.',
      shippingComplimentaryUae: 'O envio gratuito nos EAU aplica-se a entregas nos Emirados.',
      shippingLabel: 'Envio',
      shippingComplimentaryShort: 'Gratuito',
      intlShippingNote: 'Taxas abaixo destes limiares são confirmadas no pagamento.',
      deliveryAtPayment: 'O envio é confirmado no pagamento.',
    },
    checkout: {
      securePayment: 'Pagamento seguro',
      editBag: 'Editar saco',
      reviewOrder: 'Reveja a sua encomenda',
      reviewSubtitle: 'Reveja a sua seleção antes de seguir para pagamento seguro.',
      leadTimeFashion: 'Encomendada, feita para si, depois entregue · envio em 10–14 dias',
      leadTimeJewellery: 'Encomendada, feita para si, depois entregue · envio em 4–7 dias',
      leadTimeMixed: 'Peças de vestuário em 10–14 dias · joalharia em 4–7 dias',
      redirecting: 'A redirecionar...',
      continueSecurePayment: 'Continuar para pagamento seguro',
      legalAcceptPrefix: 'Li e aceito a',
      shipmentPolicy: 'Política de envio e devolução',
      legalAnd: 'e os',
      termsConditions: 'Termos e condições',
      legalRequired: 'Aceite a Política de envio e devolução e os Termos e condições',
      checkoutError: 'Não foi possível iniciar o checkout. Tente novamente.',
      stripeNotConfigured: 'Stripe checkout ainda não está configurado para este ambiente.',
      ...
      payWithCard: 'Cartão — Visa, Mastercard, Apple Pay e Google Pay',
      payWithPayPal: 'PayPal',
      payWithMollie: 'iDEAL, Klarna e mais (Europa)',

      payWithTamara: 'Tamara — pague em 4 prestações',
      selectPaymentMethod: 'Escolha um método de pagamento',
      continueWithCard: 'Pagar com cartão',
      continueWithPayPal: 'Pagar com PayPal',
      continueWithMollie: 'Continuar',

      continueWithTamara: 'Continuar com Tamara',
    },
    accessories: {
      collectionTitle: 'Acessórios',
      collectionIntro:
        'Explore signature strands, colares, brincos, pulseiras e charms para mala e telemóvel. Filtre por categoria, preço, cor e pedra.',
      collectionEyebrow: 'Coleção',
      backToHome: 'Voltar ao início',
      filter: 'Filtrar',
      products: 'Produtos',
      ...
      returnToAccessories: 'Voltar aos acessórios',
      materials: 'Materiais',
      careBullets: [
        'Manuseie com cuidado. Pedras naturais podem lascar ou partir se forem golpeadas ou caírem.',
        'Guarde numa bolsa macia apos o uso.',
        'Evite perfume, água e químicos agressivos.',
        'Limpe suavemente com um pano seco e macio. Nao mergulhe pedras naturais.',
      ],
    ...
    footer: {
      ...
      worldwideShipping: 'Envio mundial',
      deliveredGlobally: 'Envio mundial gratuito acima de {amount}.',
      freeUaeShippingTitle: 'Envio gratuito nos EAU',
      freeUaeShippingDesc: 'Entrega gratuita para encomendas acima de {amount}.',
      craftedToOrderTitle: 'Feito por encomenda',
      craftedToOrderDesc: 'Cada peça é preparada com cuidado e precisão.',
      givingForwardTitle: 'Retribuímos',
      givingForwardDesc: '20 AED de cada artigo vendido destinam-se a causas solidárias.',
      newsletter: 'Newsletter',
    ...
    deliveryBanner: {
      uaeFree: 'Envio gratuito nos EAU acima de {amount} • Entrega em 2 semanas',
      worldwide: 'Envio mundial gratuito acima de {amount}',
  ...
  id: {
    ...
    cart: {
      ...
      freeUaeShipping: 'Gratis pengiriman UEA untuk pesanan di atas {amount}',
      freeWorldwideShipping: 'Gratis pengiriman dunia untuk pesanan di atas {amount}',
      shippingComplimentary: 'Gratis pengiriman dunia sudah termasuk dalam pilihan ini.',
      shippingComplimentaryUae: 'Gratis pengiriman UEA berlaku untuk pengiriman di dalam UEA.',
      shippingLabel: 'Pengiriman',
      shippingComplimentaryShort: 'Gratis',
      intlShippingNote: 'Biaya di bawah ambang ini dikonfirmasi saat pembayaran.',
      deliveryAtPayment: 'Pengiriman dikonfirmasi saat pembayaran.',
    },
    checkout: {
      ...
      leadTimeFashion: 'Dipesan, dibuat untuk Anda, lalu dikirim · dikirim dalam 10–14 hari',
      leadTimeJewellery: 'Dipesan, dibuat untuk Anda, lalu dikirim · dikirim dalam 4–7 hari',
      leadTimeMixed: 'Busana dalam 10–14 hari · perhiasan dalam 4–7 hari',
    ...
    accessories: {
      ...
      materials: 'Material',
      careBullets: [
        'Tangani dengan hati-hati. Batu alam dapat retak atau patah jika terbentur atau terjatuh.',
        'Simpan dalam pouch lembut setelah dipakai.',
        'Hindari parfum, air, dan bahan kimia keras.',
        'Bersihkan perlahan dengan kain lembut dan kering. Jangan rendam batu alam.',
      ],
      oneSize: 'Satu ukuran',
    ...
    footer: {
      ...
      deliveredGlobally: 'Gratis pengiriman dunia di atas {amount}.',
      freeUaeShippingTitle: 'Gratis pengiriman UEA',
      freeUaeShippingDesc: 'Gratis pengiriman untuk pesanan di atas {amount}.',
      ...
      givingForwardDesc: '20 AED dari setiap item terjual dialokasikan untuk amal.',
      newsletter: 'Newsletter',
    ...
    deliveryBanner: {
      uaeFree: 'Gratis pengiriman UEA di atas {amount} • Pengiriman dalam 2 minggu',
      worldwide: 'Gratis pengiriman dunia di atas {amount}',
  ...
  ms: {
    ...
    cart: {
      ...
      freeUaeShipping: 'Penghantaran percuma UAE untuk pesanan melebihi {amount}',
      freeWorldwideShipping: 'Penghantaran percuma seluruh dunia untuk pesanan melebihi {amount}',
      shippingComplimentary: 'Penghantaran percuma seluruh dunia disertakan dengan pilihan ini.',
      shippingComplimentaryUae: 'Penghantaran percuma UAE terpakai untuk penghantaran dalam UAE.',
      shippingLabel: 'Penghantaran',
      shippingComplimentaryShort: 'Percuma',
      intlShippingNote: 'Caj di bawah ambang ini disahkan semasa pembayaran.',
      deliveryAtPayment: 'Penghantaran disahkan semasa pembayaran.',
    },
    checkout: {
      ...
      leadTimeFashion: 'Ditempah, dibuat untuk anda, kemudian dihantar · dihantar dalam 10–14 hari',
      leadTimeJewellery: 'Ditempah, dibuat untuk anda, kemudian dihantar · dihantar dalam 4–7 hari',
      leadTimeMixed: 'Pakaian dalam 10–14 hari · barang kemas dalam 4–7 hari',
      redirecting: 'Mengalihkan...',
    ...
    accessories: {
      ...
      materials: 'Bahan',
      careBullets: [
        'Kendalikan dengan teliti. Batu semula jadi boleh retak atau pecah jika terhantuk atau terjatuh.',
        'Simpan dalam pouch lembut selepas digunakan.',
        'Elakkan minyak wangi, air dan bahan kimia keras.',
        'Lap perlahan dengan kain lembut dan kering. Jangan rendam batu semula jadi.',
      ],
      oneSize: 'Satu saiz',
    ...
    footer: {
      ...
      deliveredGlobally: 'Penghantaran percuma seluruh dunia melebihi {amount}.',
      freeUaeShippingTitle: 'Penghantaran percuma UAE',
      freeUaeShippingDesc: 'Penghantaran percuma untuk pesanan melebihi {amount}.',
      ...
      givingForwardDesc: '20 AED daripada setiap item terjual diperuntukkan untuk amal.',
    ...
    deliveryBanner: {
      uaeFree: 'Penghantaran percuma UAE melebihi {amount} • Penghantaran dalam 2 minggu',
      worldwide: 'Penghantaran percuma seluruh dunia melebihi {amount}',
...
export function commerceUi(locale: AppLocale): CommerceUi {
  const pack = COMMERCE_UI[locale]
  if (!pack) throw new Error(`Missing commerce UI for locale: ${locale}`)
  return pack
}
/*
import type { AppLocale } from '@/lib/i18n/routing'
...
const EN: CommerceUi = {
  ...
  charityDedication: '20 AED from each item sold is dedicated to charity',
  newsletter: 'Newsletter',
  ...
  accessoriesHeroDescription:
    'Discover our curated collection of abaya strands, necklaces, earrings, bag charms, and phone charms.',
  price: 'Price',
...
const AR: CommerceUi = {
  ...
  charityDedication: 'يُخصَّص 20 درهماً من كل قطعة للأعمال الخيرية',
  newsletter: 'النشرة البريدية',
  ...
  accessoriesHeroDescription: 'اكتشفي مجموعتنا الراقية من تعليقات العباءة والقلادات والأقراط وتعليقات الحقائب والهواتف.',
  price: 'السعر',
