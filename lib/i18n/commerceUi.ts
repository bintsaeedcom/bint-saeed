...
const COMMERCE_UI: Record<AppLocale, CommerceUi> = {
  en: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Crafted after your order · ships in 10–14 days',
      leadTimeJewellery: 'Crafted after your order · ships in 4–7 days',
  ...
  ar: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'تُصنع بعد طلبكِ · تُشحن خلال 10–14 يوماً',
      leadTimeJewellery: 'تُصنع بعد طلبكِ · تُشحن خلال 4–7 أيام',
  ...
  fr: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Confectionnée après votre commande · expédiée sous 10 à 14 jours',
      leadTimeJewellery: 'Confectionnée après votre commande · expédiée sous 4 à 7 jours',
  ...
  de: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Nach Ihrer Bestellung gefertigt · Versand in 10–14 Tagen',
      leadTimeJewellery: 'Nach Ihrer Bestellung gefertigt · Versand in 4–7 Tagen',
  ...
  it: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Realizzata dopo il vostro ordine · spedizione in 10–14 giorni',
      leadTimeJewellery: 'Realizzata dopo il vostro ordine · spedizione in 4–7 giorni',
  ...
  es: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Hecho a pedido · envío en 10–14 días',
      leadTimeJewellery: 'Hecho a pedido · envío en 4–7 días',
  ...
  ru: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Изготавливается после заказа · отправка за 10–14 дней',
      leadTimeJewellery: 'Изготавливается после заказа · отправка за 4–7 дней',
  ...
  zh: {
    ...
    checkout: {
      ...
      leadTimeFashion: '下单后制作 · 10–14 天内发货',
      leadTimeJewellery: '下单后制作 · 4–7 天内发货',
  ...
  nl: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Gemaakt na uw bestelling · verzending binnen 10–14 dagen',
      leadTimeJewellery: 'Gemaakt na uw bestelling · verzending binnen 4–7 dagen',
  ...
  pt: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Feito após a sua encomenda · envio em 10–14 dias',
      leadTimeJewellery: 'Feito após a sua encomenda · envio em 4–7 dias',
  ...
  id: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Dibuat setelah pesanan Anda · dikirim dalam 10–14 hari',
      leadTimeJewellery: 'Dibuat setelah pesanan Anda · dikirim dalam 4–7 hari',
  ...
  ms: {
    ...
    checkout: {
      ...
      leadTimeFashion: 'Dibuat selepas tempahan anda · dihantar dalam 10–14 hari',
      leadTimeJewellery: 'Dibuat selepas tempahan anda · dihantar dalam 4–7 hari',
