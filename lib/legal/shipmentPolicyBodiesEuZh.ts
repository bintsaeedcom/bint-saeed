  ...
  fr: [
      ...
      subsections: [
        ...
        },
        {
          ...
          list: [
            ...
            'Un avoir magasin.',
            'Un remboursement, lorsque la réparation ou le remplacement n’est pas raisonnablement possible.',
          ],
        },
        {
          title: '',
    ...
    },
    {
      ...
      body: [
        ...
        'Le client reconnaît en outre le caractère sur commande de nombreuses pièces Bint Saeed et comprend les limitations applicables relatives aux remboursements, échanges et annulations.',
      ],
    },
    {
      ...
      body: [
        ...
        'Si vous avez besoin d’une livraison pour une occasion particulière ou à une date fixe, veuillez contacter le service clients avant de passer commande. Les délais d’expédition et de transit sont des estimations uniquement et ne peuvent être garantis.',
      ...
      list: [
        ...
        'Les pièces sur commande sont généralement expédiées dans un délai d’environ deux semaines après confirmation de la commande.',
        'Les articles en stock, y compris certaines bijouteries et styles prêts à expédier, sont généralement expédiés sous 1–3 jours ouvrés.',
        'Une fois expédiées, les livraisons aux Émirats arabes unis arrivent généralement dans un délai d’environ 1–3 jours ouvrés. Les livraisons internationales arrivent généralement dans un délai d’environ 3–10 jours ouvrés, selon la destination et le dédouanement.',
  ...
  de: [
      ...
      subsections: [
        ...
        },
        {
          ...
          list: [
            ...
            'Gutschrift.',
            'Erstattung, sofern Reparatur oder Ersatz nicht vernünftigerweise möglich ist.',
          ],
        },
        {
          title: '',
    ...
    },
    {
      ...
      body: [
        ...
        'Der Kunde erkennt ferner den Made-to-Order-Charakter vieler Bint-Saeed-Stücke an und versteht die geltenden Beschränkungen hinsichtlich Erstattungen, Umtausch und Stornierungen.',
      ],
    },
    {
      ...
      body: [
        ...
        'Benötigen Sie eine Lieferung zu einem bestimmten Anlass oder zu einem festen Datum, kontaktieren Sie bitte den Kundenservice vor der Bestellung. Versand- und Laufzeiten sind lediglich Schätzungen und können nicht garantiert werden.',
      ...
      list: [
        ...
        'Made-to-Order-Stücke werden in der Regel innerhalb von etwa zwei Wochen nach Bestellbestätigung versandt.',
        'Lagerartikel, einschließlich ausgewählter Schmuckstücke und versandfertiger Styles, werden in der Regel innerhalb von 1–3 Werktagen versandt.',
        'Nach dem Versand treffen Lieferungen in die VAE typischerweise innerhalb von etwa 1–3 Werktagen ein. Internationale Lieferungen treffen typischerweise innerhalb von etwa 3–10 Werktagen ein, abhängig von Zielort und Zollabfertigung.',
  ...
  it: [
      ...
      subsections: [
        ...
        },
        {
          ...
          list: [
            ...
            'Credito negozio.',
            'Rimborso, qualora riparazione o sostituzione non siano ragionevolmente possibili.',
          ],
        },
        {
          title: '',
    ...
    },
    {
      ...
      body: [
        ...
        'Il cliente riconosce inoltre la natura su ordinazione di molti pezzi Bint Saeed e comprende le limitazioni applicabili relative a rimborsi, cambi e cancellazioni.',
      ],
    },
    {
      ...
      body: [
        ...
        'Se necessita di una consegna per un’occasione particolare o entro una data fissa, contatti il Servizio Clienti prima di effettuare l’ordine. I tempi di spedizione e di transito sono stime e non possono essere garantiti.',
      ...
      list: [
        ...
        'I pezzi su ordinazione sono generalmente spediti entro circa due settimane dalla conferma dell’ordine.',
        'Gli articoli in stock, comprese gioiellerie selezionate e stili pronti per la spedizione, sono generalmente spediti entro 1–3 giorni lavorativi.',
        'Una volta spedite, le consegne negli Emirati Arabi Uniti arrivano tipicamente entro circa 1–3 giorni lavorativi. Le consegne internazionali arrivano tipicamente entro circa 3–10 giorni lavorativi, a seconda della destinazione e dello sdoganamento.',
  ...
  es: [
      ...
      subsections: [
        ...
        },
        {
          ...
          list: [
            ...
            'Cambio del artículo.',
            'Crédito de tienda.',
            'Reembolso, cuando la reparación o la sustitución no sea razonablemente posible.',
          ],
        },
        {
          title: '',
    ...
    },
    {
      ...
      body: [
        ...
        'El cliente reconoce además el carácter bajo pedido de muchas piezas Bint Saeed y comprende las limitaciones aplicables relativas a reembolsos, cambios y cancelaciones.',
      ],
    },
    {
      ...
      body: [
        ...
        'Si necesita una entrega para una ocasión concreta o en una fecha fija, contacte con Atención al Cliente antes de realizar el pedido. Los plazos de despacho y tránsito son únicamente estimaciones y no pueden garantizarse.',
      ...
      list: [
        ...
        'Las piezas bajo pedido suelen enviarse en aproximadamente dos semanas tras la confirmación del pedido.',
        'Los artículos en stock, incluida joyería seleccionada y estilos listos para enviar, suelen despacharse en 1–3 días hábiles.',
        'Una vez despachados, los envíos a los EAU suelen llegar en aproximadamente 1–3 días hábiles. Los envíos internacionales suelen llegar en aproximadamente 3–10 días hábiles, según el destino y el despacho aduanero.',
  ...
  nl: [
      ...
      subsections: [
        ...
        },
        {
          ...
          list: [
            ...
            'Winkelsaldo.',
            'Terugbetaling, wanneer reparatie of vervanging niet redelijkerwijs mogelijk is.',
          ],
        },
        {
          title: '',
    ...
    },
    {
      ...
      body: [
        ...
        'De klant erkent voorts het made-to-order-karakter van veel Bint Saeed-stukken en begrijpt de toepasselijke beperkingen met betrekking tot terugbetalingen, ruilingen en annuleringen.',
      ],
    },
    {
      ...
      body: [
        ...
        'Indien u levering voor een bepaalde gelegenheid of op een vaste datum nodig heeft, neem dan contact op met de klantenservice vóór het plaatsen van uw bestelling. Verzend- en transittijden zijn slechts schattingen en kunnen niet worden gegarandeerd.',
      ...
      list: [
        ...
        'Made-to-order-stukken worden doorgaans binnen ongeveer twee weken na orderbevestiging verzonden.',
        'Voorraadartikelen, inclusief geselecteerde sieraden en klaar-voor-verzending-stijlen, worden doorgaans binnen 1–3 werkdagen verzonden.',
        'Na verzending arriveren leveringen in de VAE typisch binnen ongeveer 1–3 werkdagen. Internationale leveringen arriveren typisch binnen ongeveer 3–10 werkdagen, afhankelijk van bestemming en douaneafhandeling.',
  ...
  pt: [
      ...
      subsections: [
        ...
        },
        {
          ...
          list: [
            ...
            'Troca do artigo.',
            'Crédito de loja.',
            'Reembolso, quando a reparação ou a substituição não seja razoavelmente possível.',
          ],
        },
        {
          title: '',
    ...
    },
    {
      ...
      body: [
        ...
        'O cliente reconhece ainda a natureza sob encomenda de muitas peças Bint Saeed e compreende as limitações aplicáveis relativas a reembolsos, trocas e cancelamentos.',
      ],
    },
    {
      ...
      body: [
        ...
        'Se necessitar de entrega para uma ocasião particular ou numa data fixa, contacte o Serviço de Apoio ao Cliente antes de efetuar a encomenda. Os prazos de expedição e de trânsito são apenas estimativas e não podem ser garantidos.',
      ...
      list: [
        ...
        'As peças sob encomenda são geralmente enviadas no prazo de aproximadamente duas semanas após a confirmação da encomenda.',
        'Os artigos em stock, incluindo joalharia selecionada e estilos prontos a enviar, são geralmente expedidos em 1–3 dias úteis.',
        'Uma vez expedidas, as entregas nos EAU chegam tipicamente no prazo de aproximadamente 1–3 dias úteis. As entregas internacionais chegam tipicamente no prazo de aproximadamente 3–10 dias úteis, consoante o destino e o desembaraço aduaneiro.',
  ...
  ru: [
      ...
      subsections: [
        ...
        },
        {
          ...
          list: [
            ...
            'Обмен товара.',
            'Кредит магазина.',
            'Возврат средств, если ремонт или замена не являются разумно возможными.',
          ],
        },
        {
          title: '',
    ...
    },
    {
      ...
      body: [
        ...
        'Клиент также признаёт характер производства многих изделий Bint Saeed на заказ и понимает применимые ограничения, связанные с возвратом средств, обменом и отменой.',
      ],
    },
    {
      ...
      body: [
        ...
        'Если вам нужна доставка к определённому событию или к фиксированной дате, пожалуйста, свяжитесь со службой поддержки клиентов до размещения заказа. Сроки отправки и транзита являются лишь оценочными и не могут быть гарантированы.',
      ...
      list: [
        ...
        'Изделия, изготовленные на заказ, обычно отправляются примерно в течение двух недель после подтверждения заказа.',
        'Товары в наличии, включая избранные украшения и стили, готовые к отправке, обычно отправляются в течение 1–3 рабочих дней.',
        'После отправки доставки в ОАЭ обычно прибывают примерно в течение 1–3 рабочих дней. Международные доставки обычно прибывают примерно в течение 3–10 рабочих дней в зависимости от пункта назначения и таможенного оформления.',
  ...
  zh: [
    ...
    },
    {
      ...
      body: [
        ...
        '客户进一步确认许多 Bint Saeed 作品属按订单制作，并理解有关退款、换货与取消的适用限制。',
      ],
    },
    {
      title: '8. 配送与交付',
      body: [
        ...
        '如您需要针对特定场合或固定日期的交付，请在下单前联系客户服务。发货与运输时效仅为估算，无法保证。',
      ...
      list: [
        ...
        '按订单制作的作品通常在订单确认后约两周内发货。',
        '现货商品（包括精选珠宝与可即发货款式）通常在 1–3 个工作日内发出。',
        '发出后，阿联酋境内配送通常约在 1–3 个工作日内送达。国际配送通常约在 3–10 个工作日内送达，视目的地与清关情况而定。',
