  ...
  fr: [
    ...
    },
    {
      ...
      list: [
        ...
        'Certains articles en stock peuvent être expédiés le jour même s’ils sont commandés avant 14 h 00, mais l’expédition peut prendre jusqu’à 3 jours ouvrés.',
        'Les pièces sur commande sont expédiées dans un délai maximum d’environ 14 jours calendaires après confirmation de la commande, soit jusqu’à 12 jours de préparation du lundi au samedi (délai de préparation : 0–12 jours ouvrés).',
  ...
  de: [
    ...
    },
    {
      ...
      list: [
        ...
        'Ausgewählte Lagerartikel können am selben Tag versandt werden, wenn sie vor 14:00 Uhr bestellt werden; der Versand kann jedoch bis zu 3 Werktage dauern.',
        'Made-to-Order-Stücke werden innerhalb von maximal etwa 14 Kalendertagen nach Bestellbestätigung versandt, entsprechend bis zu 12 Bearbeitungstagen von Montag bis Samstag (Bearbeitungszeit: 0–12 Werktage).',
  ...
  it: [
    ...
    },
    {
      ...
      list: [
        ...
        'Articoli selezionati in stock possono essere spediti lo stesso giorno se ordinati prima delle 14:00, ma la spedizione può richiedere fino a 3 giorni lavorativi.',
        'I pezzi su ordinazione sono spediti entro un massimo di circa 14 giorni di calendario dalla conferma dell’ordine, equivalenti a fino a 12 giorni di gestione dal lunedì al sabato (tempo di gestione: 0–12 giorni lavorativi).',
  ...
  es: [
    ...
    },
    {
      ...
      list: [
        ...
        'Artículos seleccionados en stock pueden despacharse el mismo día si se piden antes de las 14:00, pero el despacho puede tardar hasta 3 días hábiles.',
        'Las piezas bajo pedido se despachan en un máximo de aproximadamente 14 días naturales tras la confirmación del pedido, equivalente a hasta 12 días de gestión de lunes a sábado (tiempo de gestión: 0–12 días hábiles).',
  ...
  nl: [
    ...
    },
    {
      ...
      list: [
        ...
        'Geselecteerde voorraadartikelen kunnen op dezelfde dag worden verzonden indien besteld vóór 14:00, maar verzending kan tot 3 werkdagen duren.',
        'Made-to-order-stukken worden verzonden binnen maximaal ongeveer 14 kalenderdagen na orderbevestiging, gelijk aan tot 12 behandelingsdagen van maandag tot zaterdag (behandelingstijd: 0–12 werkdagen).',
  ...
  pt: [
    ...
    },
    {
      ...
      list: [
        ...
        'Artigos selecionados em stock podem ser expedidos no mesmo dia se encomendados antes das 14:00, mas a expedição pode demorar até 3 dias úteis.',
        'As peças sob encomenda são expedidas no prazo máximo de aproximadamente 14 dias de calendário após a confirmação da encomenda, equivalente a até 12 dias de tratamento de segunda a sábado (tempo de tratamento: 0–12 dias úteis).',
  ...
  ru: [
    ...
    },
    {
      ...
      list: [
        ...
        'Отдельные товары в наличии могут быть отправлены в тот же день, если заказ оформлен до 14:00, однако отправка может занять до 3 рабочих дней.',
        'Изделия, изготовленные на заказ, отправляются в течение максимум примерно 14 календарных дней после подтверждения заказа, что соответствует до 12 дней обработки с понедельника по субботу (время обработки: 0–12 рабочих дней).',
  ...
  zh: [
    ...
    },
    {
      ...
      list: [
        ...
        '部分现货商品若在下午 2:00 前下单，或可当日发出，但发货最长可需 3 个工作日。',
        '按订单制作的作品在订单确认后最长约 14 个日历日内发出，相当于周一至周六最多 12 个处理日（处理时间：0–12 个工作日）。',
