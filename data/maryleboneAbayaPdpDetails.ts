...
export const MARYLEBONE_HOUSE_CODES_ITEMS = [
...
export const MARYLEBONE_ORIGIN = ['Made in Abu Dhabi, United Arab Emirates'] as const
...
export function buildMaryleboneAbayaDetailGroups(locale: AppLocale = 'en'): PdpDetailGroup[] {
  return [
    ...
    },
    {
      ...
      items: [...MARYLEBONE_HOUSE_CODES_ITEMS],
    },
    {
