...
const ORDERED_APPAREL_VIEWS: Record<string, OrderedViews> = {
  ...
  'natural-stone-signature-abaya': {
    ...
    side: '/Webshop pictures/Abayas/Marylebone Abaya/Marylebone Abaya- S.JPG',
  },
  ...
  'royal-v-neck-kaftan': {
    front: '/Webshop pictures/Caftans/Mayfair Kaftan/Mayfair Kaftan- F.JPG',
    side: '/Webshop pictures/Caftans/Mayfair Kaftan/Mayfair Kaftan- S.JPG',
    detail: '/Webshop pictures/Caftans/Mayfair Kaftan/Mayfair Kaftan- D.JPG',
  ...
  'knightsbridge-dress': {
    front: '/Webshop pictures/Dresses/Knightsbridge Dress/Knightsbridge Dress- F.JPG',
