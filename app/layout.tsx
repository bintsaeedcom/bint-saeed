...
export const metadata: Metadata = {
  ...
  // Single canonical URL: language is client-side toggled (no /en /ar routes yet).
  alternates: {
    canonical: '/',
    languages: {
      'x-default': 'https://bintsaeed.com',
    },
  },
  openGraph: {
...
const organizationSchema = {
  ...
  description:
    'Bint Saeed is a UAE-based heritage-inspired modest fashion house: abayas, ready-to-wear, and jewellery, with craftsmanship rooted in Emirati traditions such as Al Talli embroidery and Khous palm-frond weaving. Ships across the UAE and GCC.',
  foundingDate: '2026',
  knowsAbout: [
    'Luxury abayas UAE',
...
const websiteSchema = {
  ...
  name: 'Bint Saeed',
  description:
    'Bint Saeed — heritage-inspired abayas and modest ready-to-wear from the UAE, with Al Talli embroidery and Khous palm-frond weaving. Online shopping with delivery across the UAE and GCC.',
  publisher: {
    '@id': 'https://bintsaeed.com/#organization',
  },
  potentialAction: [{
...
const localBusinessSchema = {
  ...
  email: 'contact@bintsaeed.com',
  description:
    'Bint Saeed offers heritage-inspired abayas and modest ready-to-wear online, with craft references to Emirati Al Talli embroidery and Khous palm-frond weaving. Delivery across UAE emirates including Abu Dhabi, Al Ain, and Dubai, and wider GCC.',
  address: {
    '@type': 'PostalAddress',
    streetAddress: 'Abu Dhabi',
    addressLocality: 'Abu Dhabi',
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'I searched for abayas at Selfridges, Harrods, Harvey Nichols, Galeries Lafayette, Printemps, Ounass, or Rubaiyat—where can I buy Bint Saeed?',
      acceptedAnswer: {
        '@type': 'Answer',
...
const webPageSchema = {
  ...
  description:
    'Bint Saeed (bintsaeed.com): UAE heritage-led abayas and modest ready-to-wear—Emirati craft traditions (Al Talli embroidery, Khous palm-frond weaving), plus lace, silk, chiffon, open, formal, and office-appropriate styles. Serves the UAE, wider Arab Gulf, and Middle East modest-fashion shoppers.',
  mainEntity: {
    '@id': 'https://bintsaeed.com/#organization',
  },
  primaryImageOfPage: {
