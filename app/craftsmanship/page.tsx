  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[linear-gradient(165deg,#f7f5f0_0%,#eceae3_42%,#e3e0d6_100%)] pt-32">
      ...
      <section className="relative container mx-auto px-6 pb-20 lg:px-16 lg:pb-28">
        ...
        <h1 data-document-h1="true" className="font-rozha text-4xl leading-[1.08] text-brand-darkRed md:text-5xl">Craftsmanship</h1>
        <p className="mt-5 max-w-2xl font-roboto text-sm leading-[1.9] tracking-wide text-brand-darkRed/75">
          Craft details, construction standards, and finishing information are integrated across our heritage and
          collection pages. Explore the full house approach to materials, form, and finish.
        </p>
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          ...
          <LocaleLink
            href="/shop"
            className="inline-flex items-center gap-2 border border-brand-darkRed/35 bg-white/80 px-7 py-3 font-roboto text-xs uppercase tracking-[0.16em] text-brand-darkRed transition-colors hover:border-brand-dustyBlue hover:text-brand-dustyBlue"
            data-cursor-hover
          >
            View Collection
          </LocaleLink>
