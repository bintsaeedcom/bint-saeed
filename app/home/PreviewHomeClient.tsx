      ...
      {quickProducts.length > 0 ? (
        <div className="pointer-events-auto relative z-[4] mx-auto mt-8 max-w-xl px-8 md:px-10">
          <input
            ...
            dir={isRTL ? 'rtl' : 'ltr'}
            className="h-3 w-full cursor-pointer appearance-none rounded-full bg-brand-stone/25 accent-brand-darkRed disabled:cursor-not-allowed disabled:opacity-40 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border [&::-webkit-slider-thumb]:border-brand-darkRed/50 [&::-webkit-slider-thumb]:bg-brand-darkRed [&::-webkit-slider-thumb]:shadow-[0_1px_4px_rgba(26,2,16,0.28)] [&::-moz-range-thumb]:h-4 [&::-moz-range-thumb]:w-4 [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border [&::-moz-range-thumb]:border-brand-darkRed/50 [&::-moz-range-thumb]:bg-brand-darkRed [&::-moz-range-thumb]:shadow-[0_1px_4px_rgba(26,2,16,0.28)]"
